/* 
This Javascript Files Containes Codes and Logics for Below Listem Elements
1. For Artists

*/

//Writing logic for scrolling artist left and right
let pop_art_left = document.getElementById("pop_art_left")
let pop_art_right = document.getElementById("pop_art_right")
let artistItem = document.getElementsByClassName("artistItem")[0];

//For moving artist to left direction by scliking on right arrow
pop_art_right.addEventListener("click", ()=>{
    artistItem.scrollLeft +=330;
})

//For moving artist to right direction by scliking on left arrow
...
const songsobj = [
    {
        ...
        <div class="sub-title">Arjit Singh & Shilpa Rao</div>`,
        poster: "Images/arjit/1.jpg"
    },
    {
        id: 2,
        songName: `Kasturi<br>
        <div class="sub-title">Arjit Singh & Kunal Verma</div>`,
    ...
    {
        id: 7,
        songName: `Pasoori Nu<br>
        <div class="sub-title">Arjit Singh & Tulsi Kumar</div>`,
        poster: "Images/arjit/7.jpg"
    },
    {
        id: 8,
        songName: `Tere Hawale<br>
        <div class="sub-title">Shilpa Rao & Arjit Singh</div>`,
        poster: "Images/arjit/8.jpg"
    },
    {
        id: 9,
        songName: `Ve Kamleyaa<br>
        <div class="sub-title">Shreya Ghoshal & Arjit Singh</div>`,
        poster: "Images/arjit/9.jpg"
    },
    {
        id: 10,
        songName: `Agar Tum Sath Ho<br>
        <div class="sub-title">Arjit Singh and Alka Yagnik</div>`,
        poster: "Images/arjit/10.jpg"
    },
    {
        id: 11,
        songName: `Kesariya<br>
        <div class="sub-title">Arjit Singh</div>`,
        poster: "Images/arjit/11.jpg"
    },
    {
        id: 12,
        songName: `Lutt Putt Gaya<br>
        <div class="sub-title">Arjit Singh</div>`,
        poster: "Images/arjit/12.jpg"
    },
    {
        id: 13,
        songName: `Satranga<br>
        <div class="sub-title">Arjit Singh</div>`,
        poster: "Images/arjit/13.jpg"
    },
...
Array.from(document.getElementsByClassName('playListPlay')).forEach((e)=>{
    e.addEventListener('click', (b)=>{
        ...
        masterPlay.classList.remove("bi-play-fill")
        masterPlay.classList.add("bi-pause-fill")
        downloadMusic.href = `Songs/arjit/${index}.mp3`
        ...
        songTitles.forEach(element =>{
            ...
            downloadMusic.setAttribute('download', songName)//Through this line.. we can download our playing song
        })
